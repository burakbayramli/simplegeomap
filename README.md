...
Regions can be plotted by passing polygon points in an N x 2 numpy array with
`plot_region`. 
...
Lake data is from [NOAA](https://www.ngdc.noaa.gov/mgg/shorelines/data/gshhg/latest/)

Cities from [here](https://github.com/dr5hn/countries-states-cities-database/blob/master/csv/cities.csv)
